    ...
    <div className="HomePage">
      <div className="HomePageTop">
        ...
        <p className="PTop">
          ...
          language learning platform worldwide. You can choose from 12060
          English teachers with an average rating of 4.9 out of 5 stars given by
          102083 customers. Book a lesson with a private English teacher today
          and start learning. Not entirely happy with your tutor? No worries,
          Preply offers free tutor replacement till you're 100% satisfied.
        </p>
